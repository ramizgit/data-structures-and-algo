...
public class LongestCommonSubstring {
    ...
    //JUST FINDS LENGTH, NOT THE ACTUAL SUBSTRING
    public static int findLongestCommonSubstringLength(String str1, String str2)
    {
        int m = str1.length();
        int n = str2.length();
